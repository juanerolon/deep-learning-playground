...
checkpointer = ModelCheckpoint(filepath='saved_models/toy_cnn_weights.hdf5',
...
if True:
    h = model.fit_generator(datagen_train.flow(train_tensors, train_targets, batch_size=batch_size),
...
model.load_weights('saved_models/toy_cnn_weights.hdf5')
