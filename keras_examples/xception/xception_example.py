...
#*************************** PRE_TRAINED_MODEL ********************************************
#Load pre-trained features otained by a pre-trained Xception convolutional neural network
...
bottleneck_features = np.load(features_path + 'DogXceptionData.npz')
...
checkpointer = ModelCheckpoint(filepath='saved_models/Xception_weights_opt.hdf5',
